...
llm = HuggingFaceHub(
    ...
    huggingfacehub_api_token= "",# Replace with your actual huggingface token
)
...
def chat_with_rag(message):
    ...
    full_text = open(r"C:\Users\harit\Downloads\rag-app-main\rag-app-main\doc_rag.txt", "r").read()
